 ...
 */
final class Version20210317145013 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE annonce (id INT AUTO_INCREMENT NOT NULL, adresse_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, date DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_F65593E54DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE auto_entrepreneur (id INT AUTO_INCREMENT NOT NULL, adresse_id INT NOT NULL, carte_visite_id INT DEFAULT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, nom_entreprise VARCHAR(50) NOT NULL, telephone VARCHAR(20) NOT NULL, email VARCHAR(255) NOT NULL, verifie TINYINT(1) NOT NULL, motdepasse VARCHAR(255) NOT NULL, sel VARCHAR(16) NOT NULL, logo VARCHAR(255) NOT NULL, siret VARCHAR(14) NOT NULL, description LONGTEXT NOT NULL, abonne DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_69593367E7927C74 (email), UNIQUE INDEX UNIQ_695933674DE7DC5C (adresse_id), UNIQUE INDEX UNIQ_6959336726F61E2E (carte_visite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cv (id INT AUTO_INCREMENT NOT NULL, situation_famille_id INT DEFAULT NULL, naissance DATETIME NOT NULL, permis TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_B66FFE92C6A2B2F2 (situation_famille_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cv_competences (id INT AUTO_INCREMENT NOT NULL, cv_id INT NOT NULL, competence_id INT NOT NULL, niveau INT NOT NULL, INDEX IDX_C79D1224CFE419E2 (cv_id), INDEX IDX_C79D122415761DAB (competence_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cv_diplome (id INT AUTO_INCREMENT NOT NULL, cv_id INT NOT NULL, diplome_id INT NOT NULL, date DATETIME NOT NULL, mention VARCHAR(50) NOT NULL, INDEX IDX_9FF8A3E8CFE419E2 (cv_id), INDEX IDX_9FF8A3E826F859E2 (diplome_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cv_langue (id INT AUTO_INCREMENT NOT NULL, cv_id INT NOT NULL, langue_id INT NOT NULL, niveau INT NOT NULL, INDEX IDX_966B490DCFE419E2 (cv_id), INDEX IDX_966B490D2AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cv_metier (id INT AUTO_INCREMENT NOT NULL, cv_id INT NOT NULL, metier_id INT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME DEFAULT NULL, INDEX IDX_549C310FCFE419E2 (cv_id), INDEX IDX_549C310FED16FA20 (metier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE employe (id INT AUTO_INCREMENT NOT NULL, adresse_id INT NOT NULL, cv_id INT DEFAULT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, telephone VARCHAR(20) NOT NULL, email VARCHAR(255) NOT NULL, verifie TINYINT(1) NOT NULL, motdepasse VARCHAR(255) NOT NULL, sel VARCHAR(16) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_F804D3B9E7927C74 (email), UNIQUE INDEX UNIQ_F804D3B94DE7DC5C (adresse_id), UNIQUE INDEX UNIQ_F804D3B9CFE419E2 (cv_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE employeur (id INT AUTO_INCREMENT NOT NULL, adresse_id INT NOT NULL, abonnement_id INT DEFAULT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, nom_entreprise VARCHAR(50) NOT NULL, telephone VARCHAR(20) NOT NULL, email VARCHAR(255) NOT NULL, verifie TINYINT(1) NOT NULL, motdepasse VARCHAR(255) NOT NULL, sel VARCHAR(16) NOT NULL, logo VARCHAR(255) NOT NULL, siret VARCHAR(14) NOT NULL, description LONGTEXT DEFAULT NULL, abonnement_fin DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_8747E1C7E7927C74 (email), UNIQUE INDEX UNIQ_8747E1C74DE7DC5C (adresse_id), INDEX IDX_8747E1C7F1D74413 (abonnement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offre_emploi (id INT AUTO_INCREMENT NOT NULL, lieu_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, debut DATETIME NOT NULL, fin DATETIME DEFAULT NULL, loge TINYINT(1) NOT NULL, heures DOUBLE PRECISION NOT NULL, salaire DOUBLE PRECISION DEFAULT NULL, deplacement TINYINT(1) NOT NULL, teletravail TINYINT(1) NOT NULL, nb_postes INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_132AD0D16AB213CC (lieu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE particulier (id INT AUTO_INCREMENT NOT NULL, adresse_id INT NOT NULL, prenom VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, telephone VARCHAR(20) NOT NULL, email VARCHAR(255) NOT NULL, verifie TINYINT(1) NOT NULL, motdepasse VARCHAR(255) NOT NULL, sel VARCHAR(16) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_6CC4D4F3E7927C74 (email), UNIQUE INDEX UNIQ_6CC4D4F34DE7DC5C (adresse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cv_competences ADD CONSTRAINT FK_C79D1224CFE419E2 FOREIGN KEY (cv_id) REFERENCES cv (id)');
        $this->addSql('ALTER TABLE cv_competences ADD CONSTRAINT FK_C79D122415761DAB FOREIGN KEY (competence_id) REFERENCES competence (id)');
        $this->addSql('ALTER TABLE cv_diplome ADD CONSTRAINT FK_9FF8A3E8CFE419E2 FOREIGN KEY (cv_id) REFERENCES cv (id)');
        $this->addSql('ALTER TABLE cv_diplome ADD CONSTRAINT FK_9FF8A3E826F859E2 FOREIGN KEY (diplome_id) REFERENCES diplome (id)');
        $this->addSql('ALTER TABLE cv_langue ADD CONSTRAINT FK_966B490DCFE419E2 FOREIGN KEY (cv_id) REFERENCES cv (id)');
        $this->addSql('ALTER TABLE cv_langue ADD CONSTRAINT FK_966B490D2AADBACD FOREIGN KEY (langue_id) REFERENCES langue (id)');
        $this->addSql('ALTER TABLE cv_metier ADD CONSTRAINT FK_549C310FCFE419E2 FOREIGN KEY (cv_id) REFERENCES cv (id)');
        $this->addSql('ALTER TABLE cv_metier ADD CONSTRAINT FK_549C310FED16FA20 FOREIGN KEY (metier_id) REFERENCES metier (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cv_competences DROP FOREIGN KEY FK_C79D122415761DAB');
        $this->addSql('ALTER TABLE cv_competences DROP FOREIGN KEY FK_C79D1224CFE419E2');
        $this->addSql('ALTER TABLE cv_diplome DROP FOREIGN KEY FK_9FF8A3E8CFE419E2');
        $this->addSql('ALTER TABLE cv_langue DROP FOREIGN KEY FK_966B490DCFE419E2');
        $this->addSql('ALTER TABLE cv_metier DROP FOREIGN KEY FK_549C310FCFE419E2');
        $this->addSql('ALTER TABLE employe DROP FOREIGN KEY FK_F804D3B9CFE419E2');
        $this->addSql('ALTER TABLE cv_diplome DROP FOREIGN KEY FK_9FF8A3E826F859E2');
        $this->addSql('ALTER TABLE cv_langue DROP FOREIGN KEY FK_966B490D2AADBACD');
        $this->addSql('ALTER TABLE cv_metier DROP FOREIGN KEY FK_549C310FED16FA20');
        ...
        $this->addSql('DROP TABLE cv_competences');
        $this->addSql('DROP TABLE cv_diplome');
        $this->addSql('DROP TABLE cv_langue');
        $this->addSql('DROP TABLE cv_metier');

 ...
 */
final class Version20210317155639 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offre_emploi (id INT AUTO_INCREMENT NOT NULL, lieu_id INT DEFAULT NULL, nom VARCHAR(50) NOT NULL, debut DATETIME NOT NULL, fin DATETIME DEFAULT NULL, loge TINYINT(1) NOT NULL, heures DOUBLE PRECISION NOT NULL, salaire DOUBLE PRECISION DEFAULT NULL, deplacement TINYINT(1) NOT NULL, teletravail TINYINT(1) NOT NULL, nb_postes INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_132AD0D16AB213CC (lieu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
